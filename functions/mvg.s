...
test ! -d "$FROM" && test -d "$TO" && mv "$FROM" "$TO" && cd "$TO" && return-success;
test ! -d "$FROM" && test ! -d "$TO" && mv "$FROM" "$TO" && cd `dirname "$TO"` && return-success;
test -d "$FROM" && test -d "$TO" && mv "$FROM" "$TO" && cd "$TO"/`basename "$FROM"` && return-success;
test -d "$FROM" && test ! -d "$TO" && mv "$FROM" "$TO" && cd "$TO" && return-success;
